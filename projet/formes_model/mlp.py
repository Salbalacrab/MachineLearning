...
movements = []
col_names = ['left', 'right', 'middle', 'motor_left', 'motor_right']

for i in range(1,13):
    data = pd.read_csv("./../data/formes/1_" + str(i) +".txt", names=col_names, header=None)
    movement = data.values
    movements.append(movement)
    data_s = pd.read_csv("./../data/formes/2_" + str(i) +".txt", names=col_names, header=None)
